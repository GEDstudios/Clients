...
(function () {
    ...
    const UI_SECTIONS = [
        {
            id: 'ui-list',
            animations: [
                { fileName: "Chat.lottie" },
                { fileName: "Voice.lottie" },
                { fileName: "Email.lottie" },
            ]
        }
    ];
    ...
    function setupUiGrid() {
        ...
        UI_SECTIONS.forEach(section => {
            ...
            populateGrid(gridEl, cardTemplate, section.animations);
        });
    }

    function populateGrid(gridContainer, cardTemplate, animations) {
